...
public class ScanActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    public void handleResult(com.google.zxing.Result rawResult) {
        ...
        String nidn = tokens.nextToken(); //12345
        ...
        Log.v("SIMPAN INI", uid+ nidn+nama+tanggal+jam);

        //Data absensi akan di cek terlebih dahulu
        boolean cekSimpan = db.TambahData(uid, nidn, nama, tanggal, jam, "Hadir", "Tidak");

        if (cekSimpan) {

            //Prosedure simpan data di cloud
            absen(uid,nidn,nama,tanggal,jam);
